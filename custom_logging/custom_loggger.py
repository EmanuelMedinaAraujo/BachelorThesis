...
class GeneralLogger:
    ...
    def __init__(self, cfg: TrainConfig = None, log_in_wandb=False, log_in_console=False, log_architecture=False):
        """
        Initializes the logger.
        :param cfg: The configuration that will be used by wandb to track the hyperparameters and run metadata.
        """
        self.log_in_wandb = cfg.logging.wandb.log_in_wandb if cfg is not None else log_in_wandb
        self.log_in_console = cfg.logging.log_in_console if cfg is not None else log_in_console
        self.log_architecture = cfg.logging.log_architecture if cfg is not None else log_architecture
