...
class LoggerCallback(BaseCallback):
    ...
    def __init__(self, logger, visualization_history, goal_to_vis, param_to_vis, hyperparams, visualization_call,
                 device, test_dataloader, num_joints, tolerable_accuracy_error, verbose: int = 2):
        ...
        self.test_env = KinematicsEnvironment(device, test_dataloader, num_joints=num_joints,
    ...
    def _on_step(self) -> bool:
        ...
        if self.n_calls % self.hyperparams.testing_interval == 0:
            mean_reward, std_reward = evaluate_policy(self.model,self.test_env , n_eval_episodes=100)
